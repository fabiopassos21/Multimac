...
uses
  ...
  Vcl.Grids, Vcl.DBGrids, uFormCadastroCidade, AdvGlowButton;
...
procedure TFormFiltroClientes.AdvGlowButton2Click(Sender: TObject);
begin
  inherited;
   Filtrar;
end;
...
procedure TFormFiltroClientes.AdvGlowButton1Click(Sender: TObject);
begin
  inherited;
...
procedure TFormFiltroClientes.AdvGlowButton3Click(Sender: TObject);
begin
  inherited;
  ValidaQueryVazia;
  FormCadastroCliente := TFormCadastroCliente.Create(Self);
...
procedure TFormFiltroClientes.AdvGlowButton4Click(Sender: TObject);
begin
  inherited;
    close;
end;
