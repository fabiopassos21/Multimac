...
begin
  ...
  try
    ...
    begin
      ...
      // Agora você pode usar o NomeArquivoXML como desejar
      ShowMessage('Arquivo selecionado: ' + NomeArquivoXML);
       nfe.NotasFiscais.Clear;


  // ou
  nfe.NotasFiscais.LoadFromFile(NomeArquivoXML, FALSE);   // utilizar quando você quer usar o arquivo XML da NFe
